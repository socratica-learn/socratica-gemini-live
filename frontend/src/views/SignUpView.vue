...
import socrateHologram from '@/assets/socrateHologram.png'
...
const isPasswordValid = computed(() => {
  ...
  return reqs.length && reqs.number && reqs.special
})
...
function validateForm(): boolean {
  ...
  if (!formData.value.password) {
    ...
    errors.value.password = 'Password must be at least 8 characters, including a number and a special character'
    isValid = false
  }
...
async function handleSubmit() {
  ...
  try {
    ...
    // Redirect to personalize workspace after successful signup
...
<template>
  <div class="signup-page">
    <div class="signup-container">
      <!-- Left Section: Image with Socrates -->
      <div class="left-section">
        <!-- Socrates Hologram Image Background -->
        <img :src="socrateHologram" alt="Socrates Hologram" class="socrates-background-image" />
      ...
      <div class="right-section">
        <div class="form-container">
          ...
          <h2 class="form-title">Create your Socratica Account</h2>
          ...
          <form @submit.prevent="handleSubmit" class="signup-form">
            ...
            <div class="form-field">
              ...
              <div class="input-shine">
                <input
                  ...
                  type="email"
                  placeholder="eg. socrates@example.com"
                  class="form-input"
            ...
            <p v-if="formData.password && !errors.password" class="password-hint">
            ...
            <!-- Login Link -->
            <p class="login-link">
              Already have an account? <router-link to="/login" class="login-link-text">Log in</router-link>
            </p>
          </form>
        </div>
      </div>
...
/* Steps Section */
/* Extra top margin so "Sign up" (step 1) aligns with right-side Step 1 content */
.steps-section {
  display: flex;
  gap: 0.5rem;
  margin-top: 11.5rem;
...
.checkbox-input {
  ...
  margin-top: 0.125rem;
  cursor: pointer;
  accent-color: rgba(212, 175, 55, 0.9);
  flex-shrink: 0;
}
